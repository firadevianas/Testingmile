...
WebUI.verifyElementText(findTestObject(null), 'It seems that CORPO has already been requested demo account')

WebUI.verifyElementText(findTestObject(null), 'Phone already Exist')
